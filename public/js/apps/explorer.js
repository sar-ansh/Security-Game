    ...
    return {
        ...
        init: {
            ...
            desktop: function() {
                ...
                d.on('dblclick', 'tbody tr', function() {
                    var x = $(this).attr('hidden_link');
                    var y = $(x).find('a').attr('href');
                    var z = $(this).attr('file_name');
                    ...
                    $('#window_file .window_main').prepend('<img id="theImg" src="js/apps/' + z + '"/>');
                    if(task$3_1 == 1){
                        check3_1(z);
                    }
                });
            ...
            wallpaper: function() {
                ...
                if ($('#desktop').length) {
                $('#explorer_app').prepend('<img id="wallpaper" class="abs" src="assets/computer/misc/wallpaper.jpg" />');
                }
            }
        },
        util: {
